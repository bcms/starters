        ...
        >
          ...
          <defs>
            ...
            <image
              ...
              width="1792"
              height="2688"
              :xlink:href="`/bcms-media${data.cover.src}`"
            />
          </defs>
        </svg>
        <div
      ...
      <div class="homeHero--description mb-6 lg:mb-14">
        <template v-for="(item, index) in data.description" :key="index">
          ...
          <BCMSImage
            ...
            :key="index"
            :media="item.image"
            class="image image_sm h-4 flex-shrink-0 mx-2 translate-y-[3px] bg-center bg-cover lg:hidden"
            :style="{
          ...
          <BCMSImage
            ...
            :key="index"
            :media="item.image"
            class="image image_lg h-10 flex-shrink-0 mx-4 translate-y-[3px] bg-center bg-cover max-lg:hidden"
            :style="{
