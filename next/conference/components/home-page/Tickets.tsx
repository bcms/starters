  ...
  return (
    <section id="tickets" className="pb-16 scroll-m-5 lg:pb-[130px]">
      <div className="container">
        <div
          className="leading-none tracking-[-0.02em] font-semibold text-center mb-3 lg:text-5xl lg:leading-none lg:mb-4"
        >
          { data.title }
        </div>
        <ContentManager
                ...
                <div className="flex items-end justify-between">
                  ...
                  <div
                    className={classNames(
                      ...
                      {
                        'bg-white text-appText': ticket.theme.selected === 'LIGHT',
                        'bg-appText text-white': ticket.theme.selected !== 'LIGHT'
                      }
                    )}
                  >
                    <span
                      className="text-sm leading-none tracking-[-0.41px] font-medium mr-2 lg:text-lg lg:leading-none"
                    >
                     Buy now
                    </span>
                    <svg className="w-[14px] h-[14px] lg:w-[18px] lg:h-[18px]" viewBox="0 0 77 72" fill="none" xmlns="http://www.w3.org/2000/svg">
                      <path d="M40.1818 71.733L32.5739 64.1989L55.3608 41.4119H0V30.4062H55.3608L32.5739 7.65625L40.1818 0.0852256L76.0057 35.9091L40.1818 71.733Z" fill="currentColor"/>
                    </svg>
                  </div>
                </div>
              </div>
