    ...
    <section className="pb-[72px] lg:pb-[136px]">
      <div className="container">
        <div className="flex items-center justify-between mb-6 lg:mb-16">
          <div
            className="leading-none tracking-[-0.02em] font-semibold text-center lg:text-5xl lg:leading-none"
          >
            { data.title }
          </div>
          <div
            className="flex px-2 py-[5px] bg-[#6BCD7D1A] rounded-[25px] text-sm leading-none tracking-[-0.04em] font-medium text-[#388045] lg:px-[15px] lg:py-2.5 lg:text-xl lg:leading-none"
          >
            ...
            <SwiperSlide key={index} >
              <div className="grid grid-cols-1 gap-6 lg:gap-12">
                {day.items.map((item, itemItem) => (
                  ...
                  >
                    <div
                      className="text-sm leading-none tracking-[-0.04em] font-medium text-appGray-600 lg:text-2xl lg:leading-none"
                    >
                      { item.hours }
                    </div>
                    <div>
                      <div
                        className="text-xs leading-none font-medium tracking-[-0.04em] text-appGray-600 mb-3 lg:text-xl lg:leading-none lg:mb-4"
                      >
                        { item.title }
                      </div>
                      <ContentManager
