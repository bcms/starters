...
import { PageProps, ReservationPageData } from '@/types';
...
const ReservationPage: React.FC<PageProps<ReservationPageData>> = ({
  header,
  footer,
  page,
}) => {
...
export const getStaticProps: GetStaticProps<
  PageProps<ReservationPageData>
> = async () => {
  const client = getBcmsClient();
  try {
    const { header, footer } = await getHeaderAndFooter(client);
    const reservationPage = (await client.entry.get({
      // Template name or ID
