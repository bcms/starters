              ...
              <React.Fragment key={index}>
                ...
                {item.image && (
                  <span
                    ...
                    className="image image_sm h-4 flex-shrink-0 mx-2 translate-y-[3px] bg-center bg-cover"
                  />
                )}
                ...
                {item.image && (
                  <span
                    ...
                    className="image image_lg h-10 flex-shrink-0 mx-4 translate-y-[3px] bg-center bg-cover"
                  />
                )}
              </React.Fragment>
            );
