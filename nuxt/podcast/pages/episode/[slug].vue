        ...
        >
            ...
            <div>
                <div class="mb-4 lg:hidden">
                    <div
                        class="leading-none font-medium tracking-[-0.8px] mb-2.5"
                    >
                        {{ data.meta.title }}
                    </div>
                    <div
                        class="text-sm leading-none tracking-[-0.8px] text-appGray-400"
                    >
                ...
                <div>
                    ...
                    <div class="flex items-center">
                        <BcmsImage
                            v-if="data.meta.guest?.meta?.en"
                            :media="data.meta.guest.meta.en.avatar_image"
