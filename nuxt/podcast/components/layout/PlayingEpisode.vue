        ...
        >
            <div class="container">
                <div class="flex items-center justify-between xl:gap-10">
                    <NuxtLink
                        to="/now-playing"
                        class="flex items-center lg:flex-1"
                    >
                        <BcmsImage
                            v-if="episode.cover_image"
                            :key="episode.cover_image.src"
                            :media="episode.cover_image"
                            class="w-8 h-8 rounded object-cover overflow-hidden mr-2.5 lg:w-14 lg:h-14 lg:mr-4"
                        />
                        <div>
                            <div
                    ...
                    >
                        ...
                        <div class="flex items-center space-x-2.5 xl:w-full">
                            <div
                                class="leading-none tracking-[-0.8px] text-appGray-400"
                            >
                                {{ getCurrentPlayTime }}
                            </div>
                    ...
                    <div
                        class="flex items-center justify-end flex-1 max-lg:hidden"
                    >
                        <SvgoVolume
                            filled
                            :font-controlled="false"
                        ...
                        <label class="relative w-[128px]">
                            <div
                                class="relative h-1 rounded overflow-hidden bg-appGray-800"
                            >
                                <div
                                    class="absolute top-0 left-0 h-full bg-white rounded"
                                    :style="{
