            ...
            <div class="container max-w-[1198px]">
                ...
                >
                    ...
                    <div class="mb-10 lg:mb-20">
                        ...
                        >
                            <button
                                v-for="(mealType, index) in data.mealTypes"
                                :key="index"
                        ...
                        <ContentManager
                            :items="activeMealTypeDescription.nodes"
...
const { data, error } = await useFetch<MenuPageResponse>('/api/menu-page');
...
const activeMealTypeDescription = computed(() => {
    return (data.value?.mealTypes.find(
