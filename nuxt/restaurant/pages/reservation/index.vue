            ...
            <div class="container max-w-[1198px]">
                ...
                >
                    ...
                    >
                        ...
                        />
                        <label
                            class="flex items-start col-span-2 cursor-pointer"
                        >
                            <input
...
import type { ReservationPageResponse } from '~/server/api/reservation-page';

const { setOgHead } = useHeadTags();
const { checkForInputErrors } = useErrors();

const { data, error } = await useFetch<ReservationPageResponse>(
