<template>
    <div
        class="w-screen h-screen flex flex-col gap-6 items-center justify-center lg:gap-10"
    >
        ...
        <NuxtLink
            to="/"
            class="flex items-center px-[15px] py-2.5 text-white bg-appAccent rounded-[32px]"
        >
            <span
