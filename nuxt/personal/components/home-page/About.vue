        ...
        <div class="relative container">
            ...
            >
                ...
                <div>
                    ...
                    />
                    <div
                        class="pb-6 border-b border-appGray-100 mb-6 lg:pb-8 lg:mb-8"
                    >
                        <div
                    ...
                    <div
                        class="pb-6 border-b border-appGray-100 lg:pb-8 lg:mb-8"
                    >
                        <div
                            class="leading-none font-medium tracking-[-0.41px] mb-5 lg:text-xl lg:leading-none"
                        >
...
const visibleDegrees = computed(() => {
    return props.education.degrees.slice(0, degreesToShow.value);
});

const visibleWorkHistoryItems = computed(() => {
    return props.workHistory.items.slice(0, workHistoryItemsToShow.value);
});
</script>
