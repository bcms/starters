        ...
        <div class="container">
            ...
            >
                <div class="bg-appGray-100 rounded-lg lg:rounded-[14px]">
                    ...
                    <div>
                        <div class="px-4 py-6 border-b border-[#CFCDC8] lg:p-8">
                            ...
                            <ContentManager
                                :items="data.meta.description_extended.nodes"
                        ...
                        <div class="px-4 py-6 border-b border-[#CFCDC8] lg:p-8">
                            ...
                            <ContentManager
                                :items="data.meta.responsibilities.nodes"
                                class="job--rt text-xs leading-normal font-medium tracking-[-0.41px] text-appGray-500 lg:text-base lg:leading-normal"
                            />
                        </div>
                ...
                >
                    ...
                    <ContentManager
                        :items="data.meta.company_description.nodes"
            ...
            >
                ...
                >
                    ...
                    >
                        <Btn
                            v-if="filteredJobs.length < data.jobs.length"
...
const { data, error } = await useFetch<JobPageResponse>(
    `/api/jobs/${route.params.slug}`,
);
...
const filteredJobs = computed(() => {
    return (
        data.value?.jobs.slice(0, paginationPage.value * jobsPerPage.value) ||
        []
    );
});
