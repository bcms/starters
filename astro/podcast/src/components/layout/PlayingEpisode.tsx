...
import BackwardIcon from '../../assets/icons/backward.svg?raw';
            ...
            <div className="container">
                <div className="flex items-center justify-between xl:gap-10">
                    ...
                    <div className="flex flex-col items-center justify-center flex-1 max-lg:hidden">
                        <div className="flex items-center space-x-7 mb-2">
                            ...
                            <button
                                ...
                                onClick={handlePrevEpisode}
                            >
                                <div dangerouslySetInnerHTML={{ __html: BackwardIcon }} className="w-6 h-6" />
                            </button>
                            <button
                            ...
                            >
                                {settings.playing ? (
                                    <div dangerouslySetInnerHTML={{ __html: PauseIcon }} className="text-appAccent w-6 h-6" />
                                ) : (
                                    <div dangerouslySetInnerHTML={{ __html: PlayIcon }} className="text-appAccent w-6 h-6" />
                                )}
                            </button>
                            <button
                                className="flex"
                            ...
                            >
                                <div dangerouslySetInnerHTML={{ __html: ForwardIcon }} className="w-6 h-6" />
                            </button>
                            <button
                                className="text-xl leading-none tracking-[-0.8px] text-appGray-400 min-w-max max-xl:hidden"
                                onClick={handleNextEpisode}
                    ...
                    <div className="flex items-center justify-end flex-1 max-lg:hidden">
                        <div dangerouslySetInnerHTML={{ __html: VolumeIcon }} className="w-6 h-6 mr-4" />
                    ...
                    >
                        {settings.playing ? (
                            <div dangerouslySetInnerHTML={{ __html: PauseIcon }} className="w-5 h-5" />
                        ) : (
                            <div dangerouslySetInnerHTML={{ __html: PlayIcon }} className="w-5 h-5" />
                        )}
                    </button>
                </div>
            </div>
