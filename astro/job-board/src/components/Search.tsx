import { type FC, type ChangeEvent, type KeyboardEvent, useState, useEffect } from 'react';
...
const SearchInput: FC<Props> = ({
    ...
    return (
        ...
        >
            <div dangerouslySetInnerHTML={{__html: icon}} className="w-[14px] h-[14px] flex-shrink-0" />
            <input
