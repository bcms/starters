...
import FileUpload from '../form/Dropzone';
...
const Form: React.FC = () => {
    ...
    const handleSubmit = async () => {
        try {
            ...
            //     const coverResponse = await fetch('/api/create-file', {
            //         method: 'POST',
            //         body: fd,
            //     });
            //     const { imageId: coverImageId } = await coverResponse.json();
            //     formData['cover_image'] = {
            //         mediaId: coverImageId,
            //     };
            //     fd.set('file', stepTwo.companyLogo.value);
            //     const logoResponse = await fetch('/api/create-file', {
            //         method: 'POST',
            //         body: fd,
            //     });
            //     const { imageId: logoId } = await logoResponse.json();
                ...
                {activeStep === 1 && (
                    <>
                        ...
                        <FormText
                            ...
                            name="jobDetails"
                            onChange={(value) =>
                                handleInputChange('jobDetails', value)
                            }
                            type="textarea"
                        />
                    </>
                ...
                {activeStep === 4 && (
                    <>
                        <FormText
                            ...
                            name="howToApply"
                            onChange={(value) =>
                                handleInputChange('howToApply', value)
                            }
                            type="textarea"
                        />
                        <FormText
