          ...
          {items.map(
            (item, index) =>
              item.bcms.meta.en && (
                ...
                >
                  <div
                    className="flex rounded-2xl overflow-hidden bg-[#E05C32] px-4 pt-4 aspect-[1.7] lg:aspect-[2.47]"
                    style={{
                      boxShadow:
                  ...
                  <div className="flex flex-col lg:flex-row lg:justify-between lg:gap-20">
                    ...
                    <ContentManager
                      item={item.bcms.meta.en.description}
