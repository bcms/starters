...
import LoadingIcon from '../assets/icons/loader.inline.svg';
import classNames from 'classnames';
import { ClientConfig } from '@thebcms/client';
import { BCMSImage } from '@thebcms/components-react';
import { ProductLite } from '../utils/product';
import { useCart } from '../context/CartContext';
import { ProductSizeEntryMetaItem } from '../../bcms/types/ts';
...
export const ProductCard: React.FC<ProductCardProps> = ({
    ...
    return (
        <div className={classNames('flex flex-col', className)} style={style}>
            <Link to={`/shop/${card.slug}`} className="group flex flex-col">
