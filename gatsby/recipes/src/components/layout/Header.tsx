...
import MenuIcon from '../../assets/icons/nav/menu.inline.svg';
import XIcon from '../../assets/icons/nav/x.inline.svg';
import { BCMSImage } from '@thebcms/components-react';
import { HeaderEntryMetaItem } from '../../../bcms/types/ts';
...
const Header: React.FC<Props> = ({ header, bcms }) => {
