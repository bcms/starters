...
const ApplyModal: React.FC<Props> = ({ close }) => {
                ...
                >
                    <fieldset className="grid grid-cols-2 items-end gap-2 lg:gap-3">
                        <FormText
                            ...
                            onChange={(value) =>
                                handelUpdateForm('firstName', value)
                            }
                        ...
                        <FormText
                            ...
                            onChange={(value) =>
                                handelUpdateForm('lastName', value)
                            }
                            value={form.lastName}
                        />
                    </fieldset>
                    ...
                    <FormText
                        name="birthDate"
                        onChange={(value) =>
                            handelUpdateForm('birthDate', value)
                        }
                    ...
                    <FormText
                        name="description"
                        onChange={(value) =>
                            handelUpdateForm('description', value)
                        }
