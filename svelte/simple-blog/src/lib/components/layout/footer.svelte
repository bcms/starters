<footer class="py-8">
	<div class="container">
		<div
			class="text-black leading-none font-medium tracking-[-0.41px] md:flex md:items-center md:justify-between"
		>
			<a
			...
			>
				Powered by
				<img src="/logo-dark.png" alt="BCMS Logo" class="w-auto h-5 ml-2 lg:h-6 lg:ml-3" />
			</a>
